...
define RKSCRIPT_INSTALL_INIT_SYSV_MOUNTALL
	$(INSTALL) -m 0755 -D $(@D)/S*mountall.sh $(TARGET_DIR)/etc/init.d/
endef
...
define RKSCRIPT_INSTALL_INIT_SYSV_RESIZEALL
	$(INSTALL) -m 0755 -D $(@D)/S*resizeall.sh $(TARGET_DIR)/etc/init.d/
endef
...
define RKSCRIPT_INSTALL_INIT_SYSV_BOOTANIM
	$(INSTALL) -m 0755 -D $(@D)/S*bootanim.sh $(TARGET_DIR)/etc/init.d/
endef
...
define RKSCRIPT_INSTALL_INIT_SYSV_ASYNC
	$(INSTALL) -m 0755 -D $(@D)/S*async-commit.sh $(TARGET_DIR)/etc/init.d/
endef
